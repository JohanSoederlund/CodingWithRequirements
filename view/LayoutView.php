...
class LayoutView
{
		...
		* @param UserView $userView object responsible for userlist output
		* @param Session $session model representation of this server session
		*/
		public function __construct(LoginView $loginView, RegisterView $registerView, DateTimeView $dateTimeView, UserView $userView, Session $session)
		{
